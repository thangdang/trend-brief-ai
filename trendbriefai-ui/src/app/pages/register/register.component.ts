  ...
  template: `
    <div class="auth-wrapper">
      <div class="auth-card">
        ...
        <h2>Tạo tài khoản</h2>
        <p class="auth-sub">Bắt đầu đọc tin thông minh</p>
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()">
          ...
          <div class="form-group">
            ...
            <input id="password" type="password" formControlName="password" placeholder="Tối thiểu 6 ký tự" />
          ...
          <div class="form-group">
            ...
            <input id="confirm" type="password" formControlName="confirm" placeholder="Nhập lại mật khẩu" />
          ...
          <button type="submit" class="btn-primary" [disabled]="loading()">
            @if (loading()) { Đang xử lý... } @else { Đăng ký }
          </button>
        </form>
